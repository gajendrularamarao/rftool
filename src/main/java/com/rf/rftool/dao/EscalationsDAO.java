...
public List<Escalations> getEscalationByAdminSerach( int userid , String siteid, String sitename, String startdate, String enddate,
 ...
 if(userid>0)	{
    ...
    if(siteid!="" && enddate!="" && startdate!="" && status!="" && userid>0  ) 
    {
    	String sql = "select * from ssaescalation where userid = '"+userid+"' and siteid = '"+siteid+"' and  startdate between '"+startdate+"' and '"+enddate+"' and  status='"+status+"';";
        System.out.println(sql);	
        list = template.query("select * from ssaescalation where userid = '"+userid+"' and  siteid ='"+siteid+"' and  startdate between '"+startdate+"' and '"+ enddate +"' and  status='"+status+"' ;",new ResultSetExtractor<List<Escalations>>(){  
        	List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
    ...
    if( enddate!="" && startdate!="" && status!="" && userid>0  ) 
    {
    	String sql = "select * from ssaescalation where userid = '"+userid+"'  and  startdate between '"+startdate+"' and '"+enddate+"' and  status='"+status+"';";
        System.out.println(sql);	
        list = template.query("select * from ssaescalation where userid = '"+userid+"'  and  startdate between '"+startdate+"' and '"+ enddate +"' and  status='"+status+"' ;",new ResultSetExtractor<List<Escalations>>(){  
        	List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
    ...
    {
    	String sql = "select * from ssaescalation where userid = '"+userid+"'  and  startdate between '"+startdate+"' and '"+enddate+"';";
        System.out.println(sql);	
        list = template.query("select * from ssaescalation where userid = '"+userid+"'  and  startdate between '"+startdate+"' and '"+ enddate +"';",new ResultSetExtractor<List<Escalations>>(){  
        	List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
    ...
    if( userid>0  ) 
    {
        ...
        System.out.println(sql);	
        list = template.query("select * from ssaescalation where userid = '"+userid+"';",new ResultSetExtractor<List<Escalations>>(){  
        	List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
   	 ...
   	 if( userid>0 &&  status!="" ) 
    		    {
    		    	String sql = "select * from ssaescalation where userid = '"+userid+"' and  status = '"+ status +"';";
    		        System.out.println(sql);	
    		        list = template.query("select * from ssaescalation where userid = '"+userid+"' and  status = '"+ status +"';",new ResultSetExtractor<List<Escalations>>(){  
    		        	List<Escalations> list1=new ArrayList<Escalations>(); 
    				     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
    				            DataAccessException {  
    ...
    if(sitename!="" && enddate!="" && startdate!="" && status!="" ) 
    {
    	String sql = "select * from ssaescalation where sitename ='"+sitename+"' and startdate between '"+startdate+"' and '"+ enddate  +"' and status='"+status+"';";
    	System.out.println(sql);
    	list = template.query("select * from ssaescalation where  sitename ='"+sitename+"' and startdate between '"+startdate+"' and '"+ enddate  +"' and status='"+status+"';",new ResultSetExtractor<List<Escalations>>(){  
    		 List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
    ...
    if(enddate!="" && startdate!="" && status!="" ) 
    {
    	String sql = "select * from ssaescalation where startdate between '"+startdate+"' and '"+ enddate  +"' and status='"+status+"';";
    	System.out.println(sql);
    	list = template.query("select * from ssaescalation where startdate between '"+startdate+"' and '"+ enddate  +"' and status='"+status+"';",new ResultSetExtractor<List<Escalations>>(){  
    		 List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
    ...
    if(enddate!="" && startdate!="" ) 
    {
    	String sql = "select * from ssaescalation where  startdate between '"+startdate+"' and '"+ enddate  +"';";
    	System.out.println(sql);
    	list = template.query("select * from ssaescalation where  startdate between '"+startdate+"' and '"+ enddate  +"';",new ResultSetExtractor<List<Escalations>>(){  
    		 List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
    ...
    if(status!="" ) 
    {
    	String sql = "select * from ssaescalation where status='"+status+"';";
    	System.out.println(sql);
    	list = template.query("select * from ssaescalation where  status='"+status+"';",new ResultSetExtractor<List<Escalations>>(){  
    		 List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
    ...
    if(sitename!="" ) 
    {
    	String sql = "select * from ssaescalation where  sitename='"+sitename+"';";
    	System.out.println(sql);
    	list = template.query("select * from ssaescalation where  sitename='"+sitename+"';",new ResultSetExtractor<List<Escalations>>(){  
    		 List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
    ...
    if(siteid!="" ) 
    {
    	String sql = "select * from ssaescalation where  siteid='"+siteid+"';";
    	System.out.println(sql);
    	list = template.query("select * from ssaescalation where  siteid='"+siteid+"';",new ResultSetExtractor<List<Escalations>>(){  
    		 List<Escalations> list1=new ArrayList<Escalations>(); 
		     public List<Escalations> extractData(ResultSet rs) throws SQLException,  
		            DataAccessException {  
