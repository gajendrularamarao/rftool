     ...
     <td>
      ...
      <td width="85%" align="center">  
       <font size="4" color="red" face="verdana" > Escalation Form </font>
        <table id="regdisplay" width="100%" border="1" align="center" height="100">
            <tr><td align="center">  <h2>You have successfully updated and Details...</h2> </td></tr>
            ...
            <tr><td id="regdisplay"> Start Date  </td> <td>  ${User.enddate}</td></tr>
